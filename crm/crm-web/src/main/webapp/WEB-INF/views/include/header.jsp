                ...
                <li class="dropdown user user-menu">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-header">
                            ...
                            <img src="http://p0iv04fjn.bkt.clouddn.com/${photo.avatar}?imageView2/1/w/300/h/300">
                            <p>
                                <shiro:principal property="employeeName"/>
                                <%--${sessionScope.current_employee.employeeName}--%>
                                <small>海外事业部</small>
                            </p>
                        </li>
                        <!-- Menu Footer-->
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="/settings" class="btn btn-default btn-flat">个人设置</a>
                            </div>
